          ...
          route.routes ? (
            ...
            <li className="relative" key={route.name}>
              <NavLink
                ...
                className="px-6 py-4 inline-flex text-black dark:text-white  items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-emerald-700 dark:hover:text-gray-200"
